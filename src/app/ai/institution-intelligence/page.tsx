...
export const metadata: Metadata = pageMetadata({
  path: "/ai/institution-intelligence",
  title: "Institution Intelligence",
  description:
    "A management-level view of what changed across the institution, which areas moved outside their usual range, and what needs attention this week.",
  socialTitle: "Institution Intelligence — NotifyHub.ai",
  image: "/og/ai.png",
});
...
const SCHEMA = [
  webPageSchema({
    path: "/ai/institution-intelligence",
    name: "Institution Intelligence | NotifyHub.ai",
    description:
      "A management-level view of what changed across the institution, which areas moved outside their usual range, and what needs attention this week.",
  }),
  breadcrumbSchema([
    ...
    { name: "Institution Intelligence", path: "/ai/institution-intelligence" },
  ]),
];
