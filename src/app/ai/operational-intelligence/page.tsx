...
export const metadata: Metadata = {
  ...
  description:
    "Day-to-day operational context for the people running classes, departments, shifts, and wards — scoped to what they are responsible for.",
  alternates: { canonical: "/ai/operational-intelligence" },
  openGraph: {
    title: "Operational Intelligence — NotifyHub.ai",
    description:
      "Day-to-day operational context for the people running classes, departments, shifts, and wards — scoped to what they are responsible for.",
    url: `${SITE.url}/ai/operational-intelligence`,
  },
};
